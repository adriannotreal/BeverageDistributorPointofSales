...
Public Class rptSalesHistory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Point_of_Sales_of_Ambergrey_Trading.rptSalesHistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalesHistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesHistory = New rptSalesHistory()
        rpt.Site = Me.Site
        Return rpt
    End Function
