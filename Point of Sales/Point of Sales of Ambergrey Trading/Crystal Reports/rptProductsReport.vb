...
Public Class rptProductsReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Point_of_Sales_of_Ambergrey_Trading.rptProductsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProductsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductsReport = New rptProductsReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
