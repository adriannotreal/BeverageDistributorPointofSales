...
Public Class rptStockHistory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Point_of_Sales_of_Ambergrey_Trading.rptStockHistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockHistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockHistory = New rptStockHistory()
        rpt.Site = Me.Site
        Return rpt
    End Function
