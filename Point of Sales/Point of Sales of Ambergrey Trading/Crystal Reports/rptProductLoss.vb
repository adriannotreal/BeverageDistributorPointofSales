...
Public Class rptProductLoss
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Point_of_Sales_of_Ambergrey_Trading.rptProductLoss.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProductLoss
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductLoss = New rptProductLoss()
        rpt.Site = Me.Site
        Return rpt
    End Function
